...
export default function SideBarItem({ icon, currentLocation, path, children }) {
    return (
        <li className={`active:bg-stone-400 p-1.5 border border-transparent rounded-lg w-full transition-colors duration-100 ease-in 
                    ${currentLocation.pathname === path ? 'bg-emerald-200 text-emerald-800 hover:bg-emerald-300' : 'hover:bg-stone-300'}`} >
            <Link to={path}>
